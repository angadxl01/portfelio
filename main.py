...
temp_join_data = {}
temp_campaign_data = {}
vip_users = {}  # 👈 VIP users track karne ke liye
valid_redeem_codes = {"VIP2026": 30}  # 👈 Code aur uske days (jaise 30 din ka VIP)
...
async def handle_text_messages(client, message):
    ...
    if state == "waiting_for_broadcast" and user_id == ADMIN_ID:
        ...
        if text in valid_redeem_codes:
            days = valid_redeem_codes.pop(text)  # Code use hone ke baad expire ho jayega
